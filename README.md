...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-k0tn1m8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-k0tn1m8.containers.anotherwebservice.com/
...
```
git clone git@github.com:jeefery/container-k0tn1m8.git
cd container-k0tn1m8
```
...
```
docker attach container-k0tn1m8
```
